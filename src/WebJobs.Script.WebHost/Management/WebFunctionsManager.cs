...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Management
{
    public class WebFunctionsManager : IWebFunctionsManager
    {
        ...
        // of triggers. It'll verify app owner ship using a SWT token valid for 2 minutes. It should be plenty.
        private async Task<(bool, string)> InternalSyncTriggers(IEnumerable<JObject> triggers)
        {
            ...
            var token = SimpleWebTokenHelper.CreateToken(DateTime.UtcNow.AddMinutes(2));
